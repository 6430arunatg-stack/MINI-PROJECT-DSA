...
* Group students by relevant categories.
* Calculate the number of students.
* Calculate average academic pressure.
* Calculate average study satisfaction.
* Calculate average work/study hours.
* Calculate average financial stress.
...
5. **Aggregation Report**
   ...
   * Contains grouped statistics such as student counts and averages.

6. **High Academic Pressure Report**

   * Contains students with high academic pressure.

7. **Categorized Student Data**
